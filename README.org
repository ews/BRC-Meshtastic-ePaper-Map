...
The current driver targets the WaveShare 7.3-inch E6 full-color PhotoPainter
for Raspberry Pi Zero (800x480), using =epd7in3e= and BCM 27 for panel power.
The older 7.5-inch =epd7in5_V2= panels use a different protocol.
